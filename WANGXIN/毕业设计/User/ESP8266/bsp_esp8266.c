...
static void ESP8266_GPIO_Config_FLOATING ( void );
...
//		Delay_ms(2000);
	...
	macESP8266_RST_LOW_LEVEL();  //macESP8266_RST_HIGH_LEVEL   macESP8266_RST_LOW_LEVEL  MOG管拉低
	
	Delay_ms(500);
	
	macESP8266_RST_HIGH_LEVEL();  //MOG管拉高
...
void ESP8266_Rst ( void )
{
	 ...
	 Delay_ms ( 500 ); 
	 macESP8266_RST_HIGH_LEVEL();Delay_ms ( 200 ); 
	#endif
