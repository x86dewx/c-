...
#define     macESP8266_RST_HIGH_LEVEL()           GPIO_ResetBits ( macESP8266_RST_PORT, macESP8266_RST_PIN )

#define     macESP8266_RST_LOW_LEVEL()            GPIO_SetBits ( macESP8266_RST_PORT, macESP8266_RST_PIN ) 
