...
#define IRDA2_GPIO_CLK 	    					RCC_APB2Periph_GPIOA		
#define IRDA2_GPIO_PIN								GPIO_Pin_3		        
#define IRDA2_GPIO_PORT_SOURCE				GPIO_PortSourceGPIOA
#define IRDA2_GPIO_PIN_SOURCE					GPIO_PinSource3

//中断相关
#define IRDA2_EXTI_LINE								EXTI_Line3
#define IRDA2_EXTI_IRQN								EXTI3_IRQn
#define IRDA2_EXTI_IRQHANDLER_FUN			EXTI3_IRQHandler


 //读取红外热释电引脚的电平
#define  Ir_Tsg_DATA_IN()	   GPIO_ReadInputDataBit(GPIOB,GPIO_Pin_9)
